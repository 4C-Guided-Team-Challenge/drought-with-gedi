...
GEDI_FOOTPRINTS = "/maps-priv/maps/drought-with-gedi/gedi_data/gedi_queried_shots_original.csv"  # noqa: E501
...
def get_monthly_vi_means_per_polygon():
    ''' Combines all monthly data sources into one DataFrame. '''
    vi_monthly = pd.read_csv(VI_MONTHLY_MEANS_CSV, index_col=0)

    # Join data sets.
    vi_data = vi_monthly.set_index(
